//version '4';
var p39_cc_1506 = 'qydb4LQogkBmx66z0cBlLVXqSUZRtq1PLUSSIGN1N6Y8WQEqN8=';
var p39_pu_1506 = null;
var p39_finished_1506 = '0';
var p39_al_1506 = '1';
var p39_cb_1506 = '1';
var p39_aid = '1506';
...
function p39_GPT_value()
    {
        ...
        var cats = getTargetingTags_1506().split("#")[2];
...
function p39_resultsArray(default_content_type, value_id, append_default) {
    var results = [];
    var pxml = getTargetingTags_1506();
...
function p39_exec_1506(ct, useDOM) {
    var w = window;
    var su = null;
    var p39_pr_1506 = null; //page referer
    var p39_cc_v_1506 = p39_cc_1506; //client code
    var p39_sd_v_1506 = null;
    var p39_akamai_v_1506 = '1';
    var p39_au_v_1506 = '';
    var p39_aid_v_1506 = '1506';
    var p39_sid_v_1506 = null;
    var page_protocol;
    ...
    switch(page_protocol) {
	    case 'http:':
	        p39_au_v_1506 = 'http://catrg.peer39.com/';
	        break;
	    case 'https:':
	        p39_au_v_1506 = 'https://catrg.peer39.com/';
	        break;
	    default:
	        p39_au_v_1506 = 'http://catrg.peer39.com/';
	}
    ...
    p39_sd_v_1506 = Math.floor(Math.random() * 1000000);

    if (w.p39_mpu_1506) {
        p39_pu_1506 = w.p39_mpu_1506;
    }

    if (!p39_pu_1506) {


        p39_pu_1506 = document.location.href;
        var ip = '0';

        try {
            p39_pu_1506 = top.location.href;
            p39_pr_1506 = document.referrer;
            ...
            try {
                p39_pu_1506 = window.parent.document.referrer;
                ip = '2';
            } catch (ee) {
                p39_pu_1506 = document.referrer;
                ip = '3';
            }
            p39_pr_1506 = null;
        }

        p39_sd_v_1506 = p39_sd_v_1506.toString() + '' + ip;
    }

    p39_pu_1506 = p39_cu(p39_pu_1506);

//run the cleaning function.

    if (typeof (p39_clean_url_1506) == "function") {
        if (p39_pu_1506) {
            p39_pu_1506 = p39_clean_url_1506(p39_pu_1506);
        }
    }

    if (p39_akamai_v_1506 == '1') {

        //here comes the magic :-)
        su = p39_au_v_1506 + p39_bau("pu=" + decodeURIComponent(p39_pu_1506) + "&cc=" + p39_cc_v_1506);
        su = su + "?aid=" + p39_zp(p39_aid_v_1506, 5);
        if (p39_sid_v_1506) {
            su = su + "&sid=" + p39_zp(p39_sid_v_1506, 5);
        } else {
            su = su + "&sid=00000";
        }
        su = p39_ae(su, "pu", decodeURIComponent(p39_pu_1506));
        su = p39_ae(su, "cc", p39_cc_v_1506);

	//not Akamai call
    } else {
        su = p39_au_v_1506 + 'cc=' + p39_cc_v_1506;
        su = p39_ae(su, "pu", p39_pu_1506);
    }
...
//var ctInfo = src.substr(src.indexOf("?")+1);
	...
	else
	{
  	...
  	su = p39_ae(su, "sd", p39_sd_v_1506);
  	su = p39_ae(su, "et", w.p39_extrk_1506);
